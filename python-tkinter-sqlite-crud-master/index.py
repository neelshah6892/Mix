...
class Product:
    ...
    def __init__(self, window):
        ...
        # Name Input
        Label(frame, text = 'Number: ').grid(row = 1, column = 0)
        self.name = Entry(frame)
        self.name.focus()
        self.name.grid(row = 1, column = 1)

        # Price Input
        Label(frame, text = 'Upload File: ').grid(row = 2, column = 0)
        ...
        self.tree.heading('#0', text = 'Number', anchor = CENTER)
        self.tree.heading('#1', text = 'Details', anchor = CENTER)
    ...
    def add_product(self):
        if self.validation():
            ...
            self.message['text'] = 'Number and File is Required'
        self.get_products()
